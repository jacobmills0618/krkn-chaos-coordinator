...
6 built-in, fully pluggable agents covering all major OpenShift component areas. Need a new domain-specific expert agent? [Drop a YAML →](config/agents/README.md)
